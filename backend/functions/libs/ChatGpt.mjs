...
import pTimeout from "./pTimeout.mjs";
...
export class ChatGPTAPI {
  ...
  constructor(opts) {
    ...
    this._debug = !!debug;
    this._fetch = fetch;
    this._completionParams = Object.assign(
      {
        model: CHATGPT_MODEL,
        temperature: 0.8,
        top_p: 1.0,
    ...
    this._getMessageById =
      getMessageById !== null && getMessageById !== void 0
        ? getMessageById
        : this._defaultGetMessageById;
    this._upsertMessage =
      upsertMessage !== null && upsertMessage !== void 0
        ? upsertMessage
  ...
  sendMessage(text, opts = {}) {
    return __awaiter(this, void 0, void 0, function* () {
      ...
      const { messages, maxTokens, numTokens } = yield this._buildMessages(
        text,
        opts
      );
      const result = {
      ...
      const responseP = new Promise((resolve, reject) =>
        __awaiter(this, void 0, void 0, function* () {
          ...
          const body = Object.assign(
            Object.assign(
              Object.assign({ max_tokens: maxTokens }, this._completionParams),
              completionParams
            ),
            { messages, stream }
          );
              ...
              url,
              {
                ...
                onMessage: (data) => {
                  ...
                  try {
                    ...
                    if (
                      (_a = response.choices) === null || _a === void 0
                        ? void 0
                        : _a.length
                    ) {
                  ...
                  new Error(
                    `OpenAI error: ${
                      ((_b =
                        res === null || res === void 0
                          ? void 0
                          : res.detail) === null || _b === void 0
                        ? void 0
                        : _b.message) ||
                      (res === null || res === void 0 ? void 0 : res.detail) ||
                      "unknown"
                    }`
                  )
                );
